                  ...
                  (movement: {
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 text-xs text-gray-600">
                        <span>
                          {movement.from_stage?.display_name} (R
                          {movement.from_room?.identifier})
                        </span>
                        <ArrowRight className="h-3 w-3" />
                        <span>
                          {movement.to_stage?.display_name} (R
