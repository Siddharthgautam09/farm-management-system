...
type AddSlaughterReportModalProps = {
  animals: Animal[]
}

export function AddSlaughterReportModal({ animals }: AddSlaughterReportModalProps) {
            ...
            >
              ...
              <div className="sticky top-0 bg-white border-b px-6 py-4 flex items-center justify-between rounded-t-xl z-10">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-xl font-bold text-gray-900">New Slaughter Report</h2>
                    <p className="text-sm text-gray-500">Record a slaughter transaction</p>
                  </div>
                </div>
                <Button
                  variant="ghost"
